...
[SOMETHING ABOUT TRANSFER LEARNING]
[SOMETHING ABOUT ZERO-SHOT??]
...
\vspace{3mm}
\noindent This research could be extended with out of distribution detection, a process that is able to identify when inputs are not expected by the neural network. This would give the neural networks an opportunity to recognise when it is not able to handle the given task, and the user an opportunity to change their approach.
